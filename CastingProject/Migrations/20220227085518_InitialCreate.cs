        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hair_Length = table.Column<int>(type: "int", nullable: false),
                    Hair_Type = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistGalleries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArtistGalleries_Artists_ArtistId",
                        column: x => x.ArtistId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistRoles", x => new { x.ArtistId, x.RoleId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtistGalleries_ArtistId",
                table: "ArtistGalleries",
                column: "ArtistId");
